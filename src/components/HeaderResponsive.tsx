            ...
            <header className ="bg-[#782024] fixed w-full">
                <div className="container mx-auto  px-4 flex items-center justify-between">
                    ...
                    <nav
                        ...
                        } md:flex gap-4 bg-cf-dark-red text-white w-full md:w-auto md:static absolute top-24 left-0 p-4 md:p-0
                        `}
                        >
                        <Link to="/"
                              className="block md:inline  hover:underline-offset-4"
                              onClick={() => setMenuOpen(false)}
                        >Home</Link>
                        <Link to="/examples/name-changer" className="block md:inline  hover:underline-offset-4"
                              onClick={() => setMenuOpen(false)}
                        >Name Changer</Link>
                    </nav>
